...
If you to try out `flang` right now, you can download it now or try it
...
This focus led to Fortran being used heavily in scientfic computing. Weather
...
is important context, so I have included it.
...
* **May 2017** The first source code release of Classic Flang as a separate
  respoitory, outside of LLVM. This is when other companies began to be
...
You will a lot of relative language in there like "reasonable". It was hard
